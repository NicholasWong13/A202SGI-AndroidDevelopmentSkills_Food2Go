...
import com.example.food2go.activity.adapter.CategoryAdapter;
import com.example.food2go.activity.adapter.PopularAdapter;
...
public class MainActivity extends AppCompatActivity implements CategoryAdapter.OnCategoryListener {
    ...
    private void recyclerViewPopularList() {
        ...
        foodlist.add(new FoodDomain("Cheese Burger","burger","",10.00));
